...
**In Claude Code (or any AI coding tool), this is the best way to create a workflow:**

1. Describe the agentic team you want to build in natural language
2. Ask Claude Code to generate a complete, documented YAML spec
...
model_tiers:
  small:
    provider: openrouter
    model: qwen/qwen3.6-27b          # reliable guided_json, fast, cheap
    api_key_env: OPENROUTER_API_KEY
    temperature: 0.2
    max_tokens: 2048
  large:
    provider: openrouter
    model: moonshotai/kimi-k2.6      # strong reasoning, large context
    api_key_env: OPENROUTER_API_KEY
    temperature: 0.3
    max_tokens: 16000
