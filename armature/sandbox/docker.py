...
class DockerSandboxProvider:
    ...
    def wrap_registry(
        ...
        shell_handler = DockerSandboxProvider._make_shell_handler(sandbox, host_workspace)
        fw_handler = DockerSandboxProvider._make_file_write_handler(host_workspace)
        fr_handler = DockerSandboxProvider._make_file_read_handler(host_workspace)
    ...
    @staticmethod
    def _make_shell_handler(sandbox: "SandboxConfig", host_workspace: Path):
        async def handler(args: dict[str, Any]) -> dict[str, Any]:
            ...
            docker_cmd += [sandbox.image, "sh", "-c", cmd]
